    ...
    <div className="about-page">
      ...
      <section className="team-section">
        <div className="container">
          ...
          >
            <h2>Nasz zespół</h2>
            <p>Poznaj osoby, które stoją za projektem "Zapracuj na przyszłość"</p>
          </motion.div>
          ...
          <div className="team-grid">
            ...
            >
              ...
              <h3>Imię Nazwisko</h3>
              <p className="team-role">Koordynator projektu</p>
              <p className="team-description">Krótki opis roli i zainteresowań zawodowych tej osoby w projekcie.</p>
            </motion.div>
            ...
            >
              ...
              <h3>Imię Nazwisko</h3>
              <p className="team-role">Operator kamery</p>
              <p className="team-description">Krótki opis roli i zainteresowań zawodowych tej osoby w projekcie.</p>
            </motion.div>
            ...
            >
              ...
              <h3>Imię Nazwisko</h3>
              <p className="team-role">Prowadzący wywiady</p>
              <p className="team-description">Krótki opis roli i zainteresowań zawodowych tej osoby w projekcie.</p>
            </motion.div>
      ...
      <section className="project-goals">
        <div className="container">
          ...
          >
            <h2>Nasze cele</h2>
            <p>Co chcemy osiągnąć poprzez projekt "Zapracuj na przyszłość"</p>
          </motion.div>
