        ...
        <div className="about-hero-bg">
          ...
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(126, 34, 206, 0.08) 0%, rgba(225, 29, 72, 0.08) 100%)",
              zIndex: 0,
            }}
          />
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(225, 29, 72, 0.08) 0%, rgba(126, 34, 206, 0.08) 100%)",
              zIndex: 0,
            }}
          />
        </div>
          ...
          <div className="about-grid">
            ...
            >
              ...
              <motion.a
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: "0 10px 15px -3px rgba(212, 1, 125, 0.3)",
                }}
                viewport={{ once: true }}
        ...
        <div className="container">
          ...
          <div className="goals-grid">
            ...
            >
              ...
              <p>{t("goals.education.description")}</p>
            </motion.div>
            ...
            >
              ...
              <h3>{t("goals.inspiration.title")}</h3>
              <p>{t("goals.inspiration.description")}</p>
            </motion.div>
            ...
            >
              ...
              <h3>{t("goals.support.title")}</h3>
              <p>{t("goals.support.description")}</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      >
        <div
          style={{
            ...
            zIndex: 0,
            background:
              "radial-gradient(circle at 90% 10%, rgba(126, 34, 206, 0.08) 0%, rgba(225, 29, 72, 0.08) 90%)",
          }}
        />
        <div className="container">
          <motion.div
